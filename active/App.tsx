    ...
    <div className="min-h-screen w-full bg-[#020617] text-slate-100 font-sans selection:bg-cyan-500/30 flex flex-col relative overflow-x-hidden">
      ...
      <AnimatePresence mode="wait">
        {showIntro && !isLoggedIn && (
          <StartAnimation onComplete={() => setShowIntro(false)} />
        )}

        {!showIntro && !isLoggedIn ? (
          <motion.div key="landing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="w-full flex flex-col">
            ...
            <section id="hero" className="min-h-screen flex flex-col items-center justify-start px-6 pt-24 pb-20 bg-gradient-to-b from-[#020617] to-[#010409] relative">
               ...
               <motion.div id="portal" initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 1 }} className="w-full max-w-md mx-auto relative z-30 pb-12">
