  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: userMsg,
        config: {
          systemInstruction: `Panggil pengguna dengan "Bro". Gaya bahasa kekinian, santai tapi cerdas. Anda adalah asisten Satmoko Studio AI Creative.`,
          temperature: 0.8
        }
      });
    ...
    <div className="flex flex-col h-full gap-6 max-w-5xl mx-auto">
      <div className="flex items-center gap-6 px-2">
        ...
        <div>
          ...
          <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-slate-600 mt-1">SATMOKO_CORE_LOGIC_v5.4</p>
        </div>
      </div>
